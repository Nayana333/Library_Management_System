...
{
echo"<script>alert('record deleted succesfully');window.location='homepageA.php';</script>";
}
else
{
echo"<script>alert('record not deleted');window.location='homepageA.php';</script>";
}
mysql_close($con);
?>
