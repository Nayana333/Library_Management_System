...
<div id="main">
     ...
     <div class="common">
           <center><h2><u>WELCOME STUDENT</u></h2></center>
         </div>
     </form>
       <form method="POST" action="booksearchh.php" >
