...
{
echo"<script>alert('book issued');window.location='homepageA.php';</script>";
...
{
 echo"<script>alert('due date should be greater than issue date');window.location='homepageA.php';</script>";
