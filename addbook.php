...
<div id="main">
    ...
    <div class="common">
        <div class="col5 rightalign"> <label>Book Id</label>   
         ...
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="bid" />
         </div>
     ...
     <div class="common">
        <div class="col5 rightalign"> <label>Book Name</label>   
         ...
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="bname" />
         </div>
     ...
     <div class="common">
        <div class="col5 rightalign"> <label>Author</label>   
         </div>
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="author" />
         </div>
       
     </div>
     <div class="common">
        <div class="col5 rightalign"> <label>COUNT</label>   
         </div>
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="count" />
         </div>
     ...
     <div class="common">
        <div class="col5 rightalign">  &nbsp;
         ...
         <div class="col5 leftalign">
            <input type="submit" class="php-form-btn" name="SUBMIT" value="SUBMIT">
         </div>
...
$query1="insert into book values($bid,'$bname','$author',$count)";
