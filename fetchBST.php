...
<form method="POST" action="updateBST.php">
<center><label>BOOK ID:</label><input type="text" name=bid value="<?php echo $bid1;?>"></center><br>
<center><label> BOOK NAME:</label><input type="text" name="bname" value="<?php echo $bname1;?>"></center><br>
<center><label>AUTHOR:</label><input type="text" name="author" value="<?php echo $author1;?>"></center><br>
