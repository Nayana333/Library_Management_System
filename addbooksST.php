    ...
    <table style="width: 98%;">
            <tr>
                    <td style="float: right;">
                       ...
                       <a href="homepageST.php"> Log off </a>
                       </div>
                        </td>
                </tr>
...
<body>
    ...
    <form method="POST" action="addbooksST_act.php">
<div id="main">
    ...
    <div class="common">
     ...
     <div class="common">
        <div class="col5 rightalign"> <label>STATUS</label>   
         </div>
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="status" />
         </div>
