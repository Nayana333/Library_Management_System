...
<body>
    <form method="POST" action="issue1ST_act.php">
...
<div id="main">
    ...
    <div class="common">
        <div class="col5 rightalign"> <label>Book Id</label>   
         ...
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="bid1" />
         </div>
     </div>
<div class="common">
        <div class="col5 rightalign">  &nbsp;
         ...
         <div class="col5 leftalign">
            <input type="submit" class="php-form-btn" name="SUBMIT" value="GET BOOK">
         </div>
...
$bid=$_POST["bid1"];
// if(isset($q1))
$q1="select bid,bname from book where bid=$bid";
...
<body>
<form method="POST" action="issue2.php">
<div class="common">
        <div class="col5 rightalign"> <label>Book Id</label>   
         </div>
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="bid" value="<?php echo $bid;?>">
         </div>
     </div>
     <div class="common">
        <div class="col5 rightalign"> <label>Boook Name</label>   
         </div>
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="bname" value="<?php echo $bname;?>">
             <?php
 }
     ?>
         </div>
...
<div class="common">
        <div class="col5 rightalign"> <label>Usn</label>   
         </div>
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="usn" />
         </div>
     </div>
<div class="common">
        <div class="col5 rightalign"> <label>Issue Date</label>   
         ...
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="idate"  value="<?php echo date('Y-m-d') ?>" readonly/>
         </div>
     </div>
<div class="common">
        <div class="col5 rightalign"> <label>Due Date</label>   
         ...
         <div class="col5 leftalign">
            <input class="php-input" type="date" name="ddate" />
         </div>
     </div>
<div class="common">
        <div class="col5 rightalign"> <label>Issued By</label>   
         ...
         <div class="col5 leftalign">
            <input class="php-input" type="text" name="iname" value="<?php echo $username;?>" readonly/>
         </div>
     </div>
<div class="common">
        <div class="col5 rightalign">  &nbsp;
         ...
         <div class="col5 leftalign">
            <input type="submit" class="php-form-btn" name="SUBMIT" value="ISSUED">
         </div>
