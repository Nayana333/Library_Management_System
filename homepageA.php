...
<div id="main">
     ...
     <div class="common">
           <center><h2><u>WELCOME ADMIN</u></h2></center>
         </div>
     </form>
       <form method="POST" action="viewstudents.php" >

       <div class="common">
          <center><input type="submit" class="php-form-btn" name="vus" value="view and update student"></center> <br>
     ...
     <form method="POST" action="viewteachers.php">
         ...
         <div class="common">
        <center><input type="submit" class="php-form-btn" name="vut" value="view and update teacher"><center><br>
         </div>
     </form>
     <form method="POST" action="viewstaff.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="vust" value="view and update staff"><center><br>
         </div>
     </form>
         <form method="POST" action="viewbook.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="vub" value="view and update book"><center><br>
         </div>
     </form>
         ...
         <div class="common">
        <center><input type="submit" class="php-form-btn" name="adb" value="add new book"><center><br>
         </div>
     </form>
     <form method="POST" action="validationstaff.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="valst" value="add new staff"><center><br>
         </div>
     </form>
     <form method="POST" action="viewfine.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="vf" value="fine details "><center><br>
         </div>
     </form>
     <form method="POST" action="issue1.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="issue" value="book issue"><center><br>
         </div>
     </form>
     <form method="POST" action="fetchIS.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="rb" value="return book"><center><br>
         </div>
     </form>
