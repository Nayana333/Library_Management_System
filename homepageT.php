...
<div id="main">
     ...
     <div class="common">
           <center><h2><u>WELCOME TEACHER</u></h2></center>
         </div>
     </form>
       <form method="POST" action="booksearchT.php" >

       <div class="common">
          <center><input type="submit" class="php-form-btn" name="bs" value="SEARCH BOOK"></center> <br>
            
         </div>
     </form>

     <form method="POST" action="viewbooksT.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="vut" value="VIEW BOOKS"><center><br>
         </div>
     </form>
     <form method="POST" action="fetchTT.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="fs" value="UPDATE DETAILS"><center><br>
         </div>
     </form>
         <form method="POST" action="teacherfine.php">

         <div class="common">
        <center><input type="submit" class="php-form-btn" name="fd" value="FINE DETAILS"><center><br>
         </div>
     </form>
