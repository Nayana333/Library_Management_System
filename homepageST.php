       ...
       <div class="logo" style="width:100% " >
        <table>
            <tr>
                ...
                <td>
                    <div>
                        <h1 style="font-size: 20px;">   NIRMALA COLLEGE LIBRARY </h1>
                </div>
                    </td>
                </tr>
...
<div id="main">
     ...
     <div class="common">
           <center><h2><u>WELCOME STAFF</u></h2></center>
         </div>
     </form>
       <form method="POST" action="viewstudentST.php" >
     ...
     <form method="POST" action="viewteachersST.php">
        ...
        <center><input type="submit" class="php-form-btn" name="vut" value="view and update teacher"><center><br>
         ...
         <form method="POST" action="viewbookstaff.php">
