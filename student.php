...
<?php
session_start();
echo"<center><font size = '32' color = 'white'>WELCOME ".$_SESSION["usn"]."</font></center>";
?>
<html>
<html>
<head>
...
<form method="POST" action="homepageS.php">
<body>
     ...
     <div class="common">
        <div class="col5 rightalign">  &nbsp;
         ...
         <div class="col5 leftalign">
            <input type="submit" class="php-form-btn" name="SUBMIT" value="STUDENT PAGE">
         </div>
