...
{
echo "<tr>";
echo "<td>".$row1["rid"]."</td>"."<td>".$row1["rname"]."</td>"."<td>".$row1["rdate"]."</td>"."<td>".$row1["fine"]."</td>"."<td>".$row1["userid"]."</td>";
?>
<td><a href="deleteFST.php?rid=<?php echo $row1['rid'];?>">delete</a></td>
<?php
echo "</tr>";
}
echo "</table></center>";
